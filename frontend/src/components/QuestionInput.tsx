      ...
      <div className="flex gap-3 items-end">
        <div className="flex-1 bg-white rounded-xl border border-gray-200 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500">
          <textarea
            ...
            className="w-full p-4 rounded-xl resize-none focus:outline-none text-gray-900 placeholder-gray-400"
            rows={2}
            maxLength={500}
            disabled={disabled}
          />
        ...
        <button
          ...
          className="px-6 py-4 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors shadow-sm flex items-center gap-2"
        >
          {disabled ? (
            <>
